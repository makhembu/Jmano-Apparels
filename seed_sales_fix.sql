...
-- 1. Update the create_order_secure function to increment total_sales
...
-- 2. Recalculate sales for existing orders to fix "0 Sold" issue
-- This CTE extracts product IDs and quantities from the JSONB array in orders
WITH sales_calc AS (
    SELECT 
