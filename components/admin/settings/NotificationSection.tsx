            ...
            {provider === 'resend' ? (
              <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-4 animate-fade-in">
                ...
                <div>
                  ...
                  <input type="email" name="from" value={smtpConfig.from || ''} onChange={handleConfigInput} placeholder="onboarding@resend.dev" className="w-full border border-gray-300 rounded-lg p-2 text-sm" />
                </div>
              </div>
            ) : (
              <div className="bg-slate-50 p-4 rounded-lg border border-slate-200 space-y-4 animate-fade-in">
