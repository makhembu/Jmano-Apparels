        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
           <div className="space-y-3 p-4 bg-slate-50/50 rounded-xl border border-slate-100">
              ...
              <Input 
                ...
                name="shopSeoTitle" 
                value={settings.shopSeoTitle || ''} 
                onChange={onChange} 
              />
              <Textarea 
                placeholder="Shop Page Description" 
                name="shopSeoDescription" 
                value={settings.shopSeoDescription || ''} 
                onChange={onChange} 
                rows={2} 
           ...
           <div className="space-y-3 p-4 bg-slate-50/50 rounded-xl border border-slate-100">
              ...
              <Input 
                ...
                name="blogSeoTitle" 
                value={settings.blogSeoTitle || ''} 
                onChange={onChange} 
              />
              <Textarea 
                placeholder="Blog Page Description" 
                name="blogSeoDescription" 
                value={settings.blogSeoDescription || ''} 
                onChange={onChange} 
                rows={2} 
                className="resize-none" 
              />
