...
export const Home: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{settings.slogan ? `Jambo Apparels | ${settings.slogan}` : 'Jambo Apparels | Faith Based Clothing'}</title>
        <meta name="description" content={settings.mission || "Christian clothing shop offering scripture-themed apparel."} />
      </Helmet>
