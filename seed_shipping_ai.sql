...
-- 1. Add Free Shipping override to products
ALTER TABLE public.products 
ADD COLUMN IF NOT EXISTS is_free_shipping BOOLEAN DEFAULT false;

-- 2. Update order calculation logic to respect product-level free shipping
-- (This ensures these items don't contribute to shipping weight/cost calculations)
...
DECLARE
  ...
  v_product_stock int;
  v_is_free_ship boolean; -- New variable
